...
Partial Class add_customer
    ...
    Private Sub InitializeComponent()
        ...
        BROADBAND_REG_DATE = New Guna.UI2.WinForms.Guna2DateTimePicker()
        BB_REG_DATE_LABEL = New Label()
        ...
        TV_Reg_Picker = New Guna.UI2.WinForms.Guna2DateTimePicker()
        TV_Reg_Label = New Label()
        ...
        ' MessageBox2
        ' 
        MessageBox2.Buttons = Guna.UI2.WinForms.MessageDialogButtons.OK
        ...
        Guna2CustomGradientPanel1.Controls.Add(ADD_CUST_RESETBTN)
        Guna2CustomGradientPanel1.Controls.Add(ADD_CUST_CREATEBTN)
        ...
        Guna2CustomGradientPanel1.Size = New Size(1378, 825)
        Guna2CustomGradientPanel1.TabIndex = 0
        ' 
        ' Guna2GroupBox1
        ' 
        Guna2GroupBox1.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
        Guna2GroupBox1.BackColor = Color.Black
        Guna2GroupBox1.BorderColor = Color.Green
        Guna2GroupBox1.BorderRadius = 3
        Guna2GroupBox1.Controls.Add(CUST_IDTYPE_COMBOBOX)
        Guna2GroupBox1.Controls.Add(CUST_IDNUMBER_TEXTBOX)
        ...
        Guna2GroupBox1.Location = New Point(18, 673)
        Guna2GroupBox1.Name = "Guna2GroupBox1"
        Guna2GroupBox1.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        Guna2GroupBox1.Size = New Size(657, 140)
        Guna2GroupBox1.TabIndex = 50
        Guna2GroupBox1.Text = "Document Details"
        ' 
        ...
        CUST_IDTYPE_COMBOBOX.CustomizableEdges = CustomizableEdges1
        Guna2Transition1.SetDecoration(CUST_IDTYPE_COMBOBOX, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_IDTYPE_COMBOBOX.Location = New Point(210, 42)
        CUST_IDTYPE_COMBOBOX.Name = "CUST_IDTYPE_COMBOBOX"
        CUST_IDTYPE_COMBOBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        ...
        CUST_IDNUMBER_TEXTBOX.CustomizableEdges = CustomizableEdges3
        Guna2Transition1.SetDecoration(CUST_IDNUMBER_TEXTBOX, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_IDNUMBER_TEXTBOX.Location = New Point(210, 89)
        ...
        CUST_IDNUMBER_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        ...
        Label1.Font = New Font("Franklin Gothic Medium", 12F, FontStyle.Bold, GraphicsUnit.Point)
        ...
        ' ADD_CUST_RESETBTN
        ' 
        ADD_CUST_RESETBTN.Anchor = AnchorStyles.None
        ADD_CUST_RESETBTN.Animated = True
        ADD_CUST_RESETBTN.Cursor = Cursors.Hand
        ADD_CUST_RESETBTN.CustomizableEdges = CustomizableEdges7
        Guna2Transition1.SetDecoration(ADD_CUST_RESETBTN, Guna.UI2.AnimatorNS.DecorationType.None)
        ADD_CUST_RESETBTN.DisabledState.BorderColor = Color.DarkGray
        ADD_CUST_RESETBTN.DisabledState.CustomBorderColor = Color.DarkGray
        ADD_CUST_RESETBTN.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        ADD_CUST_RESETBTN.DisabledState.FillColor2 = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        ADD_CUST_RESETBTN.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ADD_CUST_RESETBTN.FillColor = Color.Green
        ADD_CUST_RESETBTN.FillColor2 = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        ADD_CUST_RESETBTN.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        ADD_CUST_RESETBTN.ForeColor = Color.White
        ADD_CUST_RESETBTN.GradientMode = Drawing2D.LinearGradientMode.Vertical
        ADD_CUST_RESETBTN.HoverState.FillColor = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        ADD_CUST_RESETBTN.HoverState.FillColor2 = Color.Green
        ADD_CUST_RESETBTN.HoverState.Font = New Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        ADD_CUST_RESETBTN.Location = New Point(1038, 741)
        ADD_CUST_RESETBTN.Name = "ADD_CUST_RESETBTN"
        ADD_CUST_RESETBTN.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        ADD_CUST_RESETBTN.Size = New Size(314, 57)
        ADD_CUST_RESETBTN.TabIndex = 49
        ADD_CUST_RESETBTN.Text = "RESET"
        ' 
        ' ADD_CUST_CREATEBTN
        ' 
        ADD_CUST_CREATEBTN.Anchor = AnchorStyles.None
        ADD_CUST_CREATEBTN.Animated = True
        ADD_CUST_CREATEBTN.Cursor = Cursors.Hand
        ADD_CUST_CREATEBTN.CustomizableEdges = CustomizableEdges9
        Guna2Transition1.SetDecoration(ADD_CUST_CREATEBTN, Guna.UI2.AnimatorNS.DecorationType.None)
        ADD_CUST_CREATEBTN.DisabledState.BorderColor = Color.DarkGray
        ADD_CUST_CREATEBTN.DisabledState.CustomBorderColor = Color.DarkGray
        ADD_CUST_CREATEBTN.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        ADD_CUST_CREATEBTN.DisabledState.FillColor2 = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        ADD_CUST_CREATEBTN.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ADD_CUST_CREATEBTN.FillColor = Color.Green
        ADD_CUST_CREATEBTN.FillColor2 = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        ADD_CUST_CREATEBTN.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        ADD_CUST_CREATEBTN.ForeColor = Color.White
        ADD_CUST_CREATEBTN.GradientMode = Drawing2D.LinearGradientMode.Vertical
        ADD_CUST_CREATEBTN.HoverState.FillColor = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        ADD_CUST_CREATEBTN.HoverState.FillColor2 = Color.Green
        ADD_CUST_CREATEBTN.HoverState.Font = New Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        ADD_CUST_CREATEBTN.Location = New Point(708, 741)
        ADD_CUST_CREATEBTN.Name = "ADD_CUST_CREATEBTN"
        ADD_CUST_CREATEBTN.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        ADD_CUST_CREATEBTN.Size = New Size(336, 57)
        ADD_CUST_CREATEBTN.TabIndex = 48
        ADD_CUST_CREATEBTN.Text = "CREATE"
        ' 
        ' Guna2GroupBox7
        ' 
        ...
        CUST_USERNAME_STATUS.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        ...
        CUST_PASSWORD_TEXTBOX.CustomizableEdges = CustomizableEdges13
        ...
        CUST_PASSWORD_TEXTBOX.Location = New Point(204, 82)
        ...
        CUST_PASSWORD_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        ...
        Guna2Transition1.SetDecoration(CUST_PASSWORD_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_PASSWORD_LABEL.Location = New Point(14, 82)
        ...
        CUST_USERNAME_TEXTBOX.CustomizableEdges = CustomizableEdges15
        ...
        CUST_USERNAME_TEXTBOX.Location = New Point(204, 35)
        ...
        CUST_USERNAME_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        ...
        Guna2Transition1.SetDecoration(CUST_USERNAME_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_USERNAME_LABEL.Location = New Point(14, 35)
        ...
        Guna2GroupBox6.Controls.Add(ADD_CUSTOMER_PROGRESS)
        ...
        Guna2GroupBox6.Controls.Add(CUST_BROADBAND_PLAN_LABEL)
        Guna2GroupBox6.Controls.Add(CUST_BROADBAND_PLAN_COMBOBOX)
        Guna2GroupBox6.Controls.Add(CUST_BROADBAND_USERNAME_LABEL)
        Guna2GroupBox6.Controls.Add(CUST_BROADBAND_USERNAME_TEXTBOX)
        Guna2GroupBox6.Controls.Add(CUST_BROADBAND_COMBOBOX)
        ...
        Guna2GroupBox6.Location = New Point(708, 333)
        Guna2GroupBox6.Name = "Guna2GroupBox6"
        Guna2GroupBox6.ShadowDecoration.CustomizableEdges = CustomizableEdges33
        Guna2GroupBox6.Size = New Size(644, 378)
        Guna2GroupBox6.TabIndex = 45
        Guna2GroupBox6.Text = "Broadband Details"
        ' 
        ' ADD_CUSTOMER_PROGRESS
        ' 
        ADD_CUSTOMER_PROGRESS.BackColor = Color.Transparent
        Guna2Transition1.SetDecoration(ADD_CUSTOMER_PROGRESS, Guna.UI2.AnimatorNS.DecorationType.None)
        ADD_CUSTOMER_PROGRESS.Location = New Point(-91, 137)
        ADD_CUSTOMER_PROGRESS.Name = "ADD_CUSTOMER_PROGRESS"
        ADD_CUSTOMER_PROGRESS.ProgressColor = Color.Green
        ADD_CUSTOMER_PROGRESS.ShadowDecoration.CustomizableEdges = CustomizableEdges19
        ADD_CUSTOMER_PROGRESS.Size = New Size(99, 97)
        ADD_CUSTOMER_PROGRESS.TabIndex = 34
        ' 
        ...
        BROADBAND_REG_DATE.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        BROADBAND_REG_DATE.ForeColor = Color.White
        BROADBAND_REG_DATE.Format = DateTimePickerFormat.Long
        BROADBAND_REG_DATE.Location = New Point(213, 256)
        BROADBAND_REG_DATE.MaxDate = New Date(2023, 2, 18, 0, 0, 0, 0)
        BROADBAND_REG_DATE.MinDate = New Date(1900, 1, 1, 0, 0, 0, 0)
        ...
        BROADBAND_REG_DATE.Value = New Date(2023, 2, 2, 0, 0, 0, 0)
        ' 
        ' BB_REG_DATE_LABEL
        ' 
        BB_REG_DATE_LABEL.Anchor = AnchorStyles.Left
        Guna2Transition1.SetDecoration(BB_REG_DATE_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        BB_REG_DATE_LABEL.Font = New Font("Franklin Gothic Medium", 12F, FontStyle.Bold, GraphicsUnit.Point)
        BB_REG_DATE_LABEL.ForeColor = Color.White
        BB_REG_DATE_LABEL.Location = New Point(14, 256)
        BB_REG_DATE_LABEL.Name = "BB_REG_DATE_LABEL"
        BB_REG_DATE_LABEL.Size = New Size(192, 36)
        BB_REG_DATE_LABEL.TabIndex = 30
        BB_REG_DATE_LABEL.Text = "Registration Date :"
        BB_REG_DATE_LABEL.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' CUST_BROADBAND_LABEL
        ' 
        CUST_BROADBAND_LABEL.Anchor = AnchorStyles.None
        Guna2Transition1.SetDecoration(CUST_BROADBAND_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_BROADBAND_LABEL.Location = New Point(14, 72)
        ...
        Guna2Transition1.SetDecoration(CUST_BROADBAND_PLAN_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_BROADBAND_PLAN_LABEL.Location = New Point(14, 118)
        CUST_BROADBAND_PLAN_LABEL.Name = "CUST_BROADBAND_PLAN_LABEL"
        CUST_BROADBAND_PLAN_LABEL.Size = New Size(192, 36)
        ...
        CUST_BROADBAND_PLAN_COMBOBOX.Location = New Point(213, 118)
        ...
        Guna2Transition1.SetDecoration(CUST_BROADBAND_USERNAME_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_BROADBAND_USERNAME_LABEL.Location = New Point(14, 164)
        CUST_BROADBAND_USERNAME_LABEL.Name = "CUST_BROADBAND_USERNAME_LABEL"
        CUST_BROADBAND_USERNAME_LABEL.Size = New Size(192, 36)
        ...
        CUST_BROADBAND_USERNAME_TEXTBOX.Location = New Point(213, 164)
        ...
        CUST_BROADBAND_COMBOBOX.Location = New Point(213, 72)
        ...
        Guna2Transition1.SetDecoration(CUST_BROADBAND_PASSWORD_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_BROADBAND_PASSWORD_LABEL.Location = New Point(14, 210)
        CUST_BROADBAND_PASSWORD_LABEL.Name = "CUST_BROADBAND_PASSWORD_LABEL"
        CUST_BROADBAND_PASSWORD_LABEL.Size = New Size(192, 36)
        ...
        CUST_BROADBAND_PASSWORD_TEXTBOX.Location = New Point(213, 210)
        ...
        TV_Reg_Picker.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        TV_Reg_Picker.ForeColor = Color.White
        TV_Reg_Picker.Format = DateTimePickerFormat.Long
        TV_Reg_Picker.Location = New Point(213, 196)
        TV_Reg_Picker.MaxDate = New Date(2023, 2, 2, 0, 0, 0, 0)
        TV_Reg_Picker.MinDate = New Date(1900, 1, 1, 0, 0, 0, 0)
        ...
        TV_Reg_Picker.Value = New Date(2023, 2, 2, 0, 0, 0, 0)
        ' 
        ' TV_Reg_Label
        ' 
        TV_Reg_Label.Anchor = AnchorStyles.Left
        Guna2Transition1.SetDecoration(TV_Reg_Label, Guna.UI2.AnimatorNS.DecorationType.None)
        TV_Reg_Label.Font = New Font("Franklin Gothic Medium", 12F, FontStyle.Bold, GraphicsUnit.Point)
        TV_Reg_Label.ForeColor = Color.White
        TV_Reg_Label.Location = New Point(14, 199)
        TV_Reg_Label.Name = "TV_Reg_Label"
        TV_Reg_Label.Size = New Size(184, 36)
        TV_Reg_Label.TabIndex = 34
        TV_Reg_Label.Text = "Registration Date :"
        TV_Reg_Label.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ...
        CUST_CABLE_PLAN_COMBOBOX.Location = New Point(213, 109)
        ...
        CUST_TV_CONNECTION_COMBOBOX.Location = New Point(213, 64)
        ...
        Label9.Location = New Point(-430, 127)
        Label9.Name = "Label9"
        ...
        CUST_CHIP_ID_TEXTBOX.Location = New Point(213, 154)
        ...
        Guna2Transition1.SetDecoration(CUST_CHIP_ID_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        Guna2Transition1.SetDecoration(CUST_CABLE_PLAN_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        Guna2Transition1.SetDecoration(CUST_TV_CONNECTION_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_CRF_TEXTBOX.Location = New Point(222, -47)
        ...
        CUST_HOUSENAME_TEXTBOX.Location = New Point(204, 131)
        ...
        CUST_COUNTRY_COMBOBOX.Location = New Point(204, 311)
        ...
        CUST_COUNTRY_COMBOBOX.TextTransform = Guna.UI2.WinForms.Enums.TextTransform.UpperCase
        ' 
        ' DOB_PICKER
        ' 
        ...
        DOB_PICKER.Location = New Point(204, 87)
        ...
        DOB_PICKER.TextTransform = Guna.UI2.WinForms.Enums.TextTransform.UpperCase
        DOB_PICKER.Value = New Date(2003, 1, 1, 0, 0, 0, 0)
        ' 
        ' CUST_DOB_LABEL
        ' 
        CUST_DOB_LABEL.Anchor = AnchorStyles.Left
        Guna2Transition1.SetDecoration(CUST_DOB_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_DOB_LABEL.Location = New Point(14, 87)
        ...
        CUST_EMAIL_TEXTBOX.Location = New Point(204, 447)
        ...
        Guna2Transition1.SetDecoration(CUST_EMAIL_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_EMAIL_LABEL.Location = New Point(14, 447)
        ...
        CUST_MOBILE_TEXTBOX.Location = New Point(204, 401)
        ...
        Guna2Transition1.SetDecoration(CUST_MOBILE_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_MOBILE_LABEL.Location = New Point(14, 401)
        ...
        CUST_PINCODE_TEXTBOX.Location = New Point(204, 357)
        ...
        Guna2Transition1.SetDecoration(CUST_PINCODE_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_PINCODE_LABEL.Location = New Point(14, 357)
        ...
        CUST_STATE_COMBOBOX.Location = New Point(204, 267)
        ...
        CUST_STATE_COMBOBOX.TextTransform = Guna.UI2.WinForms.Enums.TextTransform.UpperCase
        ' 
        ' CUST_DISTRICT_LABEL
        ' 
        CUST_DISTRICT_LABEL.Anchor = AnchorStyles.Left
        Guna2Transition1.SetDecoration(CUST_DISTRICT_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_DISTRICT_LABEL.Location = New Point(14, 221)
        ...
        Guna2Transition1.SetDecoration(CUST_COUNTRY_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_COUNTRY_LABEL.Location = New Point(14, 311)
        ...
        Guna2Transition1.SetDecoration(CUST_STATE_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_STATE_LABEL.Location = New Point(14, 267)
        ...
        CUST_DISTRICT_TEXTBOX.Location = New Point(204, 221)
        ...
        CUST_AREA_TEXTBOX.Location = New Point(204, 177)
        ...
        Guna2Transition1.SetDecoration(CUST_AREA_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_AREA_LABEL.Location = New Point(14, 177)
        ...
        Guna2Transition1.SetDecoration(CUST_HOUSENAME_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_HOUSENAME_LABEL.Location = New Point(14, 131)
        ...
        CUST_NAME_TEXTBOX.Location = New Point(204, 41)
        ...
        Guna2Transition1.SetDecoration(CUST_NAME_LABEL, Guna.UI2.AnimatorNS.DecorationType.None)
        ...
        CUST_NAME_LABEL.Location = New Point(14, 41)
        CUST_NAME_LABEL.Name = "CUST_NAME_LABEL"
        CUST_NAME_LABEL.Size = New Size(168, 36)
    ...
    Friend WithEvents ADD_CUST_CREATEBTN As Guna.UI2.WinForms.Guna2GradientTileButton

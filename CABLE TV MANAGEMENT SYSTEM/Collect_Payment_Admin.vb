...
Public Class Collect_Payment_Admin
    ...
    Private Sub PrintPageHandler(sender As Object, e As PrintPageEventArgs)
        ...
        Dim text As String = " VISIONNET CABLE TV NETWORK"
        Dim text1 As String = "SALTALKE CENTRE"
        Dim text2 As String = "SECTOR-II, KOLKATA, 700091"
        Dim text3 As String = "MOB: 6295978565"
    ...
    Private Sub COLLECT_BTN_Click(sender As Object, e As EventArgs) Handles COLLECT_BTN.Click
        ...
        ElseIf CUST_PENDING_AMOUNT_TEXTBOX.Text = "0" And AMOUNT.Text = "" Then
            ...
            PAYMENT_YEAR.SelectedIndex = -1
        ElseIf AMOUNT.Text = "0" Then
            ErrorAlert.Play()
            MessageBox.Show("Minimum Amount Is 250.", "ALERT")
        Else
    ...
    Private Sub CUST_PENDING_AMOUNT_TEXTBOX_TextChanged(sender As Object, e As EventArgs) Handles CUST_PENDING_AMOUNT_TEXTBOX.TextChanged
        If Not CUST_PENDING_AMOUNT_TEXTBOX.Text = "" Then
            If Not AMOUNT.Text = "" Then
                If CUST_PENDING_AMOUNT_TEXTBOX.Text = "0" And Not (CInt(CUST_PENDING_AMOUNT_TEXTBOX.Text) + CInt(AMOUNT.Text) = CInt(AMOUNT.Text)) Then
                    If LoginType = "CUSTOMER" Then
                        MessageBox.Show("You Don't Have Any Pending Payments For The Selected Year.", "ALERT")
                    End If
                    If LoginType = "ADMIN" Then
                        MessageBox.Show("No Pending Payments For The Selected Year.", "ALERT")
                    End If
                    AMOUNT.ReadOnly = True
                Else
                    AMOUNT.ReadOnly = False
    ...
    'Code For Accepting Only Digits.

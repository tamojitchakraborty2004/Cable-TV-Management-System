...
Public Class Customer_Details
    ...
    Private Sub CUST_CRF_TEXTBOX_TextChanged_1(sender As Object, e As EventArgs) Handles CUST_CRF_TEXTBOX.TextChanged
    ...
    Private Sub CUST_CHIP_ID_LABEL_Click(sender As Object, e As EventArgs) Handles CUST_CHIP_ID_LABEL.Click

...
Partial Class REMINDER
    ...
    Private Sub InitializeComponent()
        ...
        SEND_BTN = New Guna.UI2.WinForms.Guna2GradientTileButton()
        ...
        Guna2GradientPanel1.BackColor = Color.Black
        Guna2GradientPanel1.Controls.Add(RESET_BTN)
        Guna2GradientPanel1.Controls.Add(SEND_BTN)
        Guna2GradientPanel1.Controls.Add(HEADER_LABEL)
        ...
        Guna2GradientPanel1.Size = New Size(1407, 899)
        ...
        RESET_BTN.CustomizableEdges = CustomizableEdges1
        ...
        RESET_BTN.GradientMode = Drawing2D.LinearGradientMode.Vertical
        ...
        RESET_BTN.Location = New Point(393, 806)
        RESET_BTN.Name = "RESET_BTN"
        RESET_BTN.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        RESET_BTN.Size = New Size(629, 58)
        RESET_BTN.TabIndex = 118
        RESET_BTN.Text = "RESET"
        ' 
        ' SEND_BTN
        ' 
        SEND_BTN.Anchor = AnchorStyles.Bottom
        SEND_BTN.Animated = True
        SEND_BTN.Cursor = Cursors.Hand
        SEND_BTN.CustomizableEdges = CustomizableEdges3
        SEND_BTN.DisabledState.BorderColor = Color.Transparent
        SEND_BTN.DisabledState.CustomBorderColor = Color.Transparent
        SEND_BTN.DisabledState.FillColor = Color.Black
        SEND_BTN.DisabledState.FillColor2 = Color.Black
        SEND_BTN.DisabledState.ForeColor = Color.Black
        SEND_BTN.FillColor = Color.Green
        SEND_BTN.FillColor2 = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        SEND_BTN.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        SEND_BTN.ForeColor = Color.White
        SEND_BTN.GradientMode = Drawing2D.LinearGradientMode.Vertical
        SEND_BTN.HoverState.FillColor = Color.FromArgb(CByte(7), CByte(25), CByte(4))
        SEND_BTN.HoverState.FillColor2 = Color.Green
        SEND_BTN.HoverState.Font = New Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        SEND_BTN.Location = New Point(393, 742)
        SEND_BTN.Name = "SEND_BTN"
        SEND_BTN.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        SEND_BTN.Size = New Size(629, 58)
        SEND_BTN.TabIndex = 117
        SEND_BTN.Text = "SEND"
        ' 
        ' HEADER_LABEL
        ' 
        ...
        HEADER_LABEL.Location = New Point(3, 40)
        HEADER_LABEL.Name = "HEADER_LABEL"
        HEADER_LABEL.Size = New Size(1407, 65)
        HEADER_LABEL.TabIndex = 71
        HEADER_LABEL.Text = "SENT REMINDER"
        ...
        Guna2GroupBox1.Controls.Add(Guna2ProgressIndicator1)
        Guna2GroupBox1.Controls.Add(Message_Label)
        Guna2GroupBox1.Controls.Add(MessageText)
        Guna2GroupBox1.Controls.Add(CUST_CRF_LABEL)
        Guna2GroupBox1.Controls.Add(CUST_NAME_LABEL)
        Guna2GroupBox1.Controls.Add(PAYMENT_MONTH_LISTBOX)
        Guna2GroupBox1.Controls.Add(CUST_EMAIL_LABEL)
        Guna2GroupBox1.Controls.Add(CUST_EMAIL_TEXTBOX)
        Guna2GroupBox1.Controls.Add(PAYMENT_YEAR_LABEL)
        Guna2GroupBox1.Controls.Add(CUST_NAME_TEXTBOX)
        Guna2GroupBox1.Controls.Add(SERVICE_LABEL)
        Guna2GroupBox1.Controls.Add(CUST_CRF_TEXTBOX)
        ...
        Guna2GroupBox1.Controls.Add(SEARCH_BTN)
        Guna2GroupBox1.CustomBorderThickness = New Padding(0)
        Guna2GroupBox1.CustomizableEdges = CustomizableEdges20
        ...
        Guna2GroupBox1.Location = New Point(393, 164)
        Guna2GroupBox1.Name = "Guna2GroupBox1"
        Guna2GroupBox1.ShadowDecoration.CustomizableEdges = CustomizableEdges21
        Guna2GroupBox1.Size = New Size(629, 572)
        Guna2GroupBox1.TabIndex = 116
        ' 
        ' Guna2ProgressIndicator1
        ' 
        Guna2ProgressIndicator1.Location = New Point(282, 237)
        Guna2ProgressIndicator1.Name = "Guna2ProgressIndicator1"
        Guna2ProgressIndicator1.ProgressColor = Color.Green
        Guna2ProgressIndicator1.ShadowDecoration.CustomizableEdges = CustomizableEdges5
        Guna2ProgressIndicator1.Size = New Size(67, 67)
        Guna2ProgressIndicator1.TabIndex = 119
        ...
        Message_Label.Location = New Point(21, 279)
        Message_Label.Name = "Message_Label"
        Message_Label.Size = New Size(184, 36)
        Message_Label.TabIndex = 120
        Message_Label.Text = "MESSAGE :"
        Message_Label.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' MessageText
        ' 
        MessageText.BackColor = Color.FromArgb(CByte(25), CByte(25), CByte(25))
        ...
        MessageText.Location = New Point(211, 276)
        MessageText.Name = "MessageText"
        MessageText.ReadOnly = True
        MessageText.Size = New Size(387, 274)
        MessageText.TabIndex = 119
        MessageText.Text = ""
        ' 
        ' CUST_CRF_LABEL
        ' 
        ...
        CUST_EMAIL_TEXTBOX.CustomizableEdges = CustomizableEdges6
        ...
        CUST_EMAIL_TEXTBOX.Location = New Point(211, 111)
        ...
        CUST_EMAIL_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges7
        CUST_EMAIL_TEXTBOX.Size = New Size(387, 36)
        CUST_EMAIL_TEXTBOX.TabIndex = 115
        ' 
        ' PAYMENT_YEAR_LABEL
        ' 
        ...
        CUST_NAME_TEXTBOX.CustomizableEdges = CustomizableEdges8
        ...
        CUST_NAME_TEXTBOX.Location = New Point(211, 69)
        ...
        CUST_NAME_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges9
        CUST_NAME_TEXTBOX.Size = New Size(387, 36)
        CUST_NAME_TEXTBOX.TabIndex = 93
        ' 
        ' SERVICE_LABEL
        ' 
        ...
        CUST_CRF_TEXTBOX.CustomizableEdges = CustomizableEdges10
        ...
        CUST_CRF_TEXTBOX.Location = New Point(211, 27)
        ...
        CUST_CRF_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges11
        CUST_CRF_TEXTBOX.Size = New Size(273, 36)
        CUST_CRF_TEXTBOX.TabIndex = 90
        ' 
        ' SERVICE_COMBOBOX
        ' 
        ...
        SERVICE_COMBOBOX.CustomizableEdges = CustomizableEdges12
        ...
        SERVICE_COMBOBOX.Location = New Point(211, 195)
        SERVICE_COMBOBOX.Name = "SERVICE_COMBOBOX"
        SERVICE_COMBOBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges13
        SERVICE_COMBOBOX.Size = New Size(387, 36)
        SERVICE_COMBOBOX.Style = Guna.UI2.WinForms.Enums.TextBoxStyle.Material
        SERVICE_COMBOBOX.TabIndex = 112
        ' 
        ' PAYMENT_YEAR
        ' 
        ...
        PAYMENT_YEAR.CustomizableEdges = CustomizableEdges14
        ...
        PAYMENT_YEAR.Location = New Point(211, 153)
        PAYMENT_YEAR.Name = "PAYMENT_YEAR"
        PAYMENT_YEAR.ShadowDecoration.CustomizableEdges = CustomizableEdges15
        PAYMENT_YEAR.Size = New Size(387, 36)
        PAYMENT_YEAR.Style = Guna.UI2.WinForms.Enums.TextBoxStyle.Material
        PAYMENT_YEAR.TabIndex = 107
        ' 
        ...
        CUST_PENDING_AMOUNT_TEXTBOX.CustomizableEdges = CustomizableEdges16
        ...
        CUST_PENDING_AMOUNT_TEXTBOX.Location = New Point(211, 237)
        ...
        CUST_PENDING_AMOUNT_TEXTBOX.ShadowDecoration.CustomizableEdges = CustomizableEdges17
        CUST_PENDING_AMOUNT_TEXTBOX.Size = New Size(387, 36)
        CUST_PENDING_AMOUNT_TEXTBOX.TabIndex = 106
        ' 
        ' SEARCH_BTN
        ' 
        SEARCH_BTN.Animated = True
        SEARCH_BTN.CustomizableEdges = CustomizableEdges18
        ...
        SEARCH_BTN.Location = New Point(475, 24)
        SEARCH_BTN.Name = "SEARCH_BTN"
        SEARCH_BTN.ShadowDecoration.CustomizableEdges = CustomizableEdges19
        SEARCH_BTN.Size = New Size(123, 36)
        SEARCH_BTN.TabIndex = 91
    ...
    Friend WithEvents CUST_CRF_LABEL As Label
    Friend WithEvents CUST_NAME_TEXTBOX As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents CUST_NAME_LABEL As Label
    Friend WithEvents PAYMENT_YEAR_LABEL As Label
    Friend WithEvents PAYMENT_YEAR As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents SERVICE_COMBOBOX As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents SERVICE_LABEL As Label
    Friend WithEvents CUST_PENDING_AMOUNT_TEXTBOX As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents PENDING_AMOUNT_LABEL As Label
    ...
    Friend WithEvents PAYMENT_MONTH_LISTBOX As ListBox
    Friend WithEvents Guna2ProgressIndicator1 As Guna.UI2.WinForms.Guna2ProgressIndicator
    Friend WithEvents SEND_BTN As Guna.UI2.WinForms.Guna2GradientTileButton
    Friend WithEvents MessageText As RichTextBox
End Class
